...
CREATE TABLE `messageinterne_utilisateur` (
  ...
  `destinataires_email` varchar(255) NOT NULL,
  KEY `FK9ujg3g1pmvwn22528tjs8smtb` (`destinataires_email`),
  KEY `FKp15gfrqdp798aofo2lh1sxy01` (`MessageInterne_id_message_interne`),
  CONSTRAINT `FK9ujg3g1pmvwn22528tjs8smtb` FOREIGN KEY (`destinataires_email`) REFERENCES `utilisateur` (`email`),
...
-- Dump completed on 2021-03-01 23:18:40
