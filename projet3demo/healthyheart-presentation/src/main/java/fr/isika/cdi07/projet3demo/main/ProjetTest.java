...
public class ProjetTest implements CommandLineRunner {
...
//	Logger log = LoggerFactory.getLogger(this.getClass());
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(ProjetTest.class,args);
...
//		DonMonetaire monDon = new DonMonetaire();
//		monDon.setDate(Date.from(Instant.now()));
//		monDon.setMontant(10020.00);
//		
//		DonMonetaire donFull = donService.ajout(monDon);
//		
//		
//		log.info("infos dons : " + donFull + "/ Id : " + donFull.getIdDon());
//		
//		donFull.setMontant(1200.00);
//		DonMonetaire donFull2 = donService.ajout(donFull);
//		
//		log.info("infos dons modifie : " + donFull2 + "/ Id : " + donFull2.getIdDon());
